...
exports.testHtml = function (test) {
  ...
  TestRun(test)
    .addError(1, "Expected an identifier and instead saw '<'.", { character: 1 })
    .addError(1, "Expected an assignment or function call and instead saw an expression.")
    .addError(1, "Missing semicolon.")
    .addError(1, "Expected an identifier and instead saw '<'.", { character: 7 })
    .addError(1, "Unrecoverable syntax error. (100% scanned).")
    .test(html, {});
  test.done();
};
...
exports["destructuring var in function scope"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(12, "Missing semicolon.", { character: 28 })
    .addError(12, "Expected an assignment or function call and instead saw an expression.", { character: 29 })
    .addError(12, "Missing semicolon.", { character: 30 })
    .addError(12, "Expected an identifier and instead saw ']'.")
    .addError(12, "Expected an assignment or function call and instead saw an expression.", { character: 31 })
...
exports["destructuring var errors"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(11, "Missing semicolon.", { character: 26 })
    .addError(11, "Expected an assignment or function call and instead saw an expression.", { character: 27 })
    .addError(11, "Missing semicolon.", { character: 28 })
    .addError(11, "Expected an identifier and instead saw ']'.")
    .addError(11, "Expected an assignment or function call and instead saw an expression.", { character: 29 })
    .addError(3,  "'z' is not defined.")
...
exports["destructuring const errors"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(5, "Missing semicolon.", { character: 28 })
    .addError(5, "Expected an assignment or function call and instead saw an expression.", { character: 29 })
    .addError(5, "Missing semicolon.", { character: 30 })
    .addError(5, "Expected an identifier and instead saw ']'.")
    .addError(5, "Expected an assignment or function call and instead saw an expression.", { character: 31 })
    .test(code, {esnext: true, unused: true, undef: true});
...
exports["destructuring globals with syntax error"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(4, "Expected ',' and instead saw ';'.")
    .addError(5, "Expected ']' to match '[' from line 5 and instead saw ';'.")
    .addError(5, "Missing semicolon.", { character: 22 })
    .addError(5, "Expected an assignment or function call and instead saw an expression.", { character: 23 })
    .addError(5, "Missing semicolon.", { character: 24 })
    .addError(5, "Expected an identifier and instead saw ']'.")
    .addError(5, "Expected an assignment or function call and instead saw an expression.", { character: 25 })
...
exports["empty destructuring"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(3, "Empty destructuring.", { character: 12 })
    .addError(3, "Empty destructuring.", { character: 16 })
    .addError(4, "Empty destructuring.", { character: 10 })
    .addError(4, "Empty destructuring.", { character: 18 })
    .test(code, { esnext: true });
...
exports["non var destructuring assignment statement"] = function (test) {
  ...
  TestRun(test)
    .addError(2, "Expected an assignment or function call and instead saw an expression.", { character: 2 })
    .addError(2, "Missing semicolon.", { character: 3 })
    .addError(2, "Expected an identifier and instead saw '='.")
    .addError(2, "Expected an assignment or function call and instead saw an expression.", { character: 5 })
    .addError(2, "Missing semicolon.", { character: 6 })
    .addError(2, "Expected an assignment or function call and instead saw an expression.", { character: 7 })
    .addError(3, "Bad assignment.")
    .addError(4, "Bad assignment.")
...
exports["array comprehension imbrication with dest array as es5"] = function (test) {
  ...
  TestRun(test)
    .addError(1, "'array comprehension' is only available in Mozilla JavaScript extensions (use moz option).", { character: 1 })
    .addError(1, "'array comprehension' is only available in Mozilla JavaScript extensions (use moz option).", { character: 17 })
    .test(code, {undef: true, predef: ["print"]}); // es5
...
exports["array comprehension imbrication with dest array as legacy JS"] = function (test) {
  ...
  TestRun(test)
    .addError(1, "'array comprehension' is only available in Mozilla JavaScript extensions (use moz option).", { character: 1 })
    .addError(1, "'array comprehension' is only available in Mozilla JavaScript extensions (use moz option).", { character: 30 })
    .addError(1, "Expected 'for' and instead saw '['.", { character: 3 })
    .addError(1, "Expected 'for' and instead saw '['.", { character: 31 })
    .addError(1, "'for each' is only available in Mozilla JavaScript extensions (use moz option).")
    .test(code, {es3: true, undef: true, predef: ["print"]});
...
exports["array destructuring for of as es5"] = function (test) {
  ...
  TestRun(test, "basic")
    .addError(1, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(1, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(1, "Creating global 'for' variable. Should be 'for (var i ...'.")
    .addError(1, "Creating global 'for' variable. Should be 'for (var v ...'.")
  ...
  TestRun(test, "errors #1")
    ...
    .addError(2, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(2, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(2, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 5 })
    .addError(2, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 12 })
    .addError(3, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(3, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(3, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(3, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 5 })
    .addError(3, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 12 })
    .addError(4, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(4, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(4, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(5, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(5, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(5, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(5, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 16 })
    .addError(6, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(6, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(6, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(6, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(6, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 16 })
  ...
  TestRun(test, "errors #2")
    ...
    .addError(2, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(2, "'let' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(2, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(2, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 16 })
    .addError(3, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(3, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(3, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(3, "'let' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(3, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(3, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 16 })
    .addError(4, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(4, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(4, "'const' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(4, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    ...
    .addError(5, "'const' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(5, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(5, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 18 })
    .addError(6, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(6, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(6, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(6, "'const' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(6, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(6, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 18 })
...
exports["object destructuring for of as es5"] = function (test) {
  ...
  TestRun(test, "errors #1")
    ...
    .addError(5, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(5, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(5, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 5 })
    .addError(5, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 24 })
    .addError(6, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(6, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(6, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(6, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 5 })
    .addError(6, "'destructuring assignment' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 24 })
    .addError(7, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(7, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(7, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(8, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(8, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(8, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(8, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 28 })
    .addError(9, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(9, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(9, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(9, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(9, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 28 })
    .test(bad, {undef: true, predef: ["print"]}); // es5
  ...
  TestRun(test, "errors #2")
    ...
    .addError(5, "'let' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(5, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(5, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 28 })
    .addError(6, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(6, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(6, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(6, "'let' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(6, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(6, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 28 })
    .addError(7, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(7, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(7, "'const' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(7, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    ...
    .addError(8, "'const' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(8, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(8, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 30 })
    .addError(9, "'for of' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(9, "Invalid for-of loop left-hand-side: initializer is forbidden.")
    .addError(9, "Invalid for-of loop left-hand-side: more than one ForBinding.")
    .addError(9, "'const' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(9, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 6 })
    .addError(9, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 30 })
    .test(bad2, {undef: true, predef: ["print"]}); // es5
...
exports["no let not directly within a block"] = function (test) {
  ...
  var run = TestRun(test)
    ...
    .addError(10, "Let declaration not directly within block.", { character: 12 })
    .addError(10, "Let declaration not directly within block.", { character: 38 })
    .addError(10, "Let declaration not directly within block.", { character: 54 })
...
exports["no const not directly within a block"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(8, "Const declaration not directly within block.", { character: 12 })
    .addError(8, "Const declaration not directly within block.", { character: 40 })
    .addError(8, "Const declaration not directly within block.", { character: 58 })
...
exports["object short notation: mixed"] = function (test) {
  ...
  TestRun(test)
    .addError(2, "'object short notation' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 17 })
    .addError(2, "'object short notation' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 20 })
    .addError(3, "'object short notation' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 11 })
    .addError(3, "'object short notation' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 20 })
  .test(code);
...
exports.classElementEmpty = function (test) {
  ...
  TestRun(test)
    ...
    .addError(6, "Unnecessary semicolon.", { character: 3 })
    .addError(6, "Unnecessary semicolon.", { character: 4 })
...
exports["test for line breaks with 'yield'"] = function (test) {
  ...
  var run = TestRun(test)
    ...
    .addError(9, "Missing semicolon.")
    .addError(10, "Expected an identifier and instead saw '?'.")
    .addError(10, "Expected an assignment or function call and instead saw an expression.", { character: 5 })
    .addError(10, "Missing semicolon.")
    .addError(10, "Label 'i' on j statement.")
    .addError(10, "Expected an assignment or function call and instead saw an expression.", { character: 11 })
    .addError(13, "Missing semicolon.")
    .addError(14, "Expected an assignment or function call and instead saw an expression.");
...
exports["test destructuring function parameters as es5"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(5, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(5, "'arrow function syntax (=>)' is only available in ES6 (use 'esversion: 6').")
    .addError(6, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 7 })
    .addError(6, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 14 })
    .addError(6, "'arrow function syntax (=>)' is only available in ES6 (use 'esversion: 6').")
    .addError(7, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(7, "'arrow function syntax (=>)' is only available in ES6 (use 'esversion: 6').")
    ...
    .addError(16, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 7 })
    .addError(16, "'destructuring binding' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).", { character: 17 })
    .addError(16, "'arrow function syntax (=>)' is only available in ES6 (use 'esversion: 6').")
...
exports.parsingCommas = function (test) {
  ...
  TestRun(test)
    ...
    .addError(5, "Expected an identifier and instead saw ';'.")
    .addError(5, "Expected ')' to match '(' from line 5 and instead saw ';'.")
    .addError(5, "Expected an assignment or function call and instead saw an expression.", { character: 9 })
    .addError(5, "Missing semicolon.", { character: 10 })
    .addError(6, "Unexpected ','.")
    .addError(5, "Expected an assignment or function call and instead saw an expression.", { character: 12 })
    .addError(5, "Missing semicolon.", { character: 13 })
    .addError(6, "Expected an identifier and instead saw ','.")
    .addError(6, "Expected an assignment or function call and instead saw an expression.", { character: 9 })
    .addError(6, "Missing semicolon.", { character: 10 })
    .addError(6, "Expected an identifier and instead saw ')'.")
    .addError(6, "Expected an assignment or function call and instead saw an expression.", { character: 10 })
    .addError(6, "Missing semicolon.", { character: 11 })
    .test(src);
