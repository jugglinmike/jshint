...
exports.testCustomGlobals = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "Read only.")
    .addError(3, 23232323, "Read only.")
...
exports.testUnusedDefinedGlobals = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "'bar' is defined but never used.")
...
exports.multilineGlobalDeclarations = function (test) {
  ...
  TestRun(test)
    .addError(12, 23232323, "'pi' is defined but never used.")
...
exports.testNewArray = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "The array literal notation [] is preferable.")
    .test('new Array();');
...
exports.testNewObject = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "The object literal notation {} is preferable.")
    .test('Object();');
...
exports.testUndefinedAsParam = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "Expected an identifier and instead saw 'undefined' (a reserved word).")
    .test(code1);
...
exports.noDelete = function (test) {
  TestRun(test)
    .addError(1, 23232323, 'Variables should not be deleted.')
...
exports.switchFallThrough = function (test) {
  ...
  TestRun(test)
    .addError(3, 23232323, "Expected a 'break' statement before 'case'.")
    .addError(18, 23232323, "Expected a 'break' statement before 'default'.")
    .addError(40, 23232323, "Unexpected ':'.")
    .test(src);
...
exports.switchDefaultFirst = function (test) {
  ...
  TestRun(test)
    .addError(5, 23232323, "Expected a 'break' statement before 'default'.")
    .test(src);
...
exports.returnStatement = function (test) {
  ...
  TestRun(test)
    .addError(3, 23232323, "Did you mean to return a conditional instead of an assignment?")
    .addError(38, 23232323, "Line breaking error 'return'.")
    .addError(38, 23232323, "Missing semicolon.")
    .addError(39, 23232323, "Unnecessary semicolon.")
    .test(src, { es3: true });
...
exports.argsInCatchReused = function (test) {
  ...
  TestRun(test)
    .addError(6, 23232323, "'e' is already defined.")
    .addError(12, 23232323, "Do not assign to the exception parameter.")
    .addError(13, 23232323, "Do not assign to the exception parameter.")
    .addError(24, 23232323, "'e' is not defined.")
...
exports.yesEmptyStmt = function (test) {
  ...
  TestRun(test)
    ...
    .addError(10, 23232323, "Unnecessary semicolon.")
    .addError(17, 23232323, "Unnecessary semicolon.")
...
exports.insideEval = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "eval can be harmful.")
    .addError(3, 23232323, "eval can be harmful.")
    .addError(5, 23232323, "eval can be harmful.")
    .addError(7, 23232323, "eval can be harmful.")
    .addError(9, 23232323, "eval can be harmful.")
    .addError(11, 23232323, "Implied eval. Consider passing a function instead of a string.")
    .addError(13, 23232323, "Implied eval. Consider passing a function instead of a string.")
    .addError(15, 23232323, "Implied eval. Consider passing a function instead of a string.")
    .addError(17, 23232323, "Implied eval. Consider passing a function instead of a string.")

    // The "TestRun" class (and these errors) probably needs some
    // facility for checking the expected scope of the error
    .addError(13, 23232323, "Unexpected early end of program.")
    .addError(13, 23232323, "Unrecoverable syntax error. (100% scanned).")
...
exports.noExcOnTooManyUndefined = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "'a' is not defined.")
    .addError(1, 23232323, "'b' is not defined.")
...
exports.defensiveSemicolon = function (test) {
  ...
  TestRun(test)
    .addError(16, 23232323, "Unnecessary semicolon.")
    .addError(17, 23232323, "Unnecessary semicolon.")
...
exports.invalidOptions = function (test) {
  TestRun(test)
    .addError(0, 23232323, "Bad option: 'invalid'.")
...
exports.testInvalidSource = function (test) {
  TestRun(test)
    .addError(0, 23232323, "Input is neither a string nor an array of strings.")
    .test(undefined);
...
exports.testConstructor = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "Do not use Number as a constructor.", {
      character: 1
    })
    .test(code, {es3: true});
...
exports.missingRadix = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "Missing radix parameter.", {
      character: 12
    })
    .test(code, {es3: true});
...
exports.testSparseArrays = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "Extra comma. (it breaks older versions of IE)", { character: 16 })
    .addError(1, 23232323, "Extra comma. (it breaks older versions of IE)", { character: 23 })
    .addError(1, 23232323, "Extra comma. (it breaks older versions of IE)", { character: 28 })
    .addError(1, 23232323, "Extra comma. (it breaks older versions of IE)", { character: 40 })
    .test(src, {es3: true});
...
exports.testReserved = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "Expected an identifier and instead saw 'volatile' (a reserved word).")
    .addError(5, 23232323, "Expected an identifier and instead saw 'let' (a reserved word).")
    .addError(10, 23232323, "Expected an identifier and instead saw 'let' (a reserved word).")
    .addError(13, 23232323, "Expected an identifier and instead saw 'class' (a reserved word).")
    .addError(14, 23232323, "Expected an identifier and instead saw 'else' (a reserved word).")
    .addError(15, 23232323, "Expected an identifier and instead saw 'protected' (a reserved word).")
    .test(src, {es3: true});
...
exports.testES5Reserved = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "Expected an identifier and instead saw 'default' (a reserved word).")
    .addError(3, 23232323, "Unexpected 'in'.")
    .addError(3, 23232323, "Expected an identifier and instead saw 'in' (a reserved word).")
    .addError(6, 23232323, "Expected an identifier and instead saw 'default' (a reserved word).")
    .addError(7, 23232323, "Expected an identifier and instead saw 'new' (a reserved word).")
    .addError(8, 23232323, "Expected an identifier and instead saw 'class' (a reserved word).")
    .addError(9, 23232323, "Expected an identifier and instead saw 'default' (a reserved word).")
    .addError(10, 23232323, "Expected an identifier and instead saw 'in' (a reserved word).")
    .addError(11, 23232323, "Expected an identifier and instead saw 'in' (a reserved word).")
    .test(src, {es3: true});
...
exports.testCatchBlocks = function (test) {
  ...
  TestRun(test)
    .addError(19, 23232323, "'w' is already defined.")
    .addError(35, 23232323, "'u2' used out of scope.")
    .addError(36, 23232323, "'w2' used out of scope.")
    .test(src, { es3: true, undef: true, devel: true });

  src = fs.readFileSync(__dirname + '/fixtures/gh618.js', 'utf8');

  TestRun(test)
    .addError(5, 23232323, "Value of 'x' may be overwritten in IE 8 and earlier.")
    .addError(15, 23232323, "Value of 'y' may be overwritten in IE 8 and earlier.")
    .test(src, { es3: true, undef: true, devel: true });
...
exports.testNumericParams = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "Expected a small integer or 'false' and instead saw 'face'.")
...
exports.testForIn = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "Creating global 'for' variable. Should be 'for (var i ...'.")
    .test(src, {es3: true});
  ...
  TestRun(test, "bad lhs errors")
    .addError(2, 23232323, "Invalid for-in loop left-hand-side: more than one ForBinding.")
    .addError(3, 23232323, "Invalid for-in loop left-hand-side: more than one ForBinding.")
    .addError(4, 23232323, "Invalid for-in loop left-hand-side: initializer is forbidden.")
    .addError(5, 23232323, "Invalid for-in loop left-hand-side: initializer is forbidden.")
    .test(src);
...
exports.testUndefinedAssignment = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "It's not necessary to initialize 'x' to 'undefined'.")
    .addError(2, 23232323, "It's not necessary to initialize 'y' to 'undefined'.")
    .addError(3, 23232323, "It's not necessary to initialize 'z' to 'undefined'.")
    .addError(4, 23232323, "It's not necessary to initialize 'a' to 'undefined'.")
    .addError(6, 23232323, "It's not necessary to initialize 'c' to 'undefined'.")
    .addError(7, 23232323, "It's not necessary to initialize 'd' to 'undefined'.")
    .addError(9, 23232323, "It's not necessary to initialize 'f' to 'undefined'.")
    .addError(10, 23232323, "It's not necessary to initialize 'g' to 'undefined'.")
    .addError(11, 23232323, "It's not necessary to initialize 'h' to 'undefined'.")
    .test(src, {esnext: true});
...
exports.testES6Modules = function (test) {
  ...
  var importConstErrors = [
    [51, 23232323, "Attempting to override '$' which is a constant."],
    [52, 23232323, "Attempting to override 'emGet' which is a constant."],
    [53, 23232323, "Attempting to override 'one' which is a constant."],
    [54, 23232323, "Attempting to override '_' which is a constant."],
    [55, 23232323, "Attempting to override 'ember2' which is a constant."],
    [57, 23232323, "'$' has already been declared."],
    [58, 23232323, "'emGet' has already been declared."],
    [58, 23232323, "'set' has already been declared."],
    [59, 23232323, "'_' has already been declared."],
    [60, 23232323, "'ember2' has already been declared."]
  ];
  ...
  testRun = TestRun(test)
    .addError(3, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(4, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(5, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(6, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(7, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(8, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(9, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(10, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(11, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(22, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(26, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(30, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(31, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(32, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(36, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(40, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(44, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(46, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(47, 23232323, "'class' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(48, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(48, 23232323, "'class' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(47, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(46, 23232323, "'class' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).")
    .addError(57, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(58, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(59, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(60, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(65, 23232323, "'import' is only available in ES6 (use 'esversion: 6').")
    .addError(67, 23232323, "'export' is only available in ES6 (use 'esversion: 6').")
    .addError(67, 23232323, "'function*' is only available in ES6 (use 'esversion: 6').")
    .addError(67, 23232323, "'yield' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz).");
  importConstErrors.forEach(function(error) { testRun.addError.apply(testRun, error); });
  testRun.test(src, {});
...
exports.testES6ModulesNamedExportsAffectUnused = function (test) {
  ...
  TestRun(test)
    .addError(19, 23232323, "const 'c1u' is initialized to 'undefined'.")
    .addError(19, 23232323, "const 'c2u' is initialized to 'undefined'.")
    .test(src1, {
      esnext: true,
      unused: true
    });
...
exports.testConstRedeclaration = function (test) {
  ...
  TestRun(test)
    ...
    .addError(6, 23232323, "'a' was used before it was declared, which is illegal for 'const' variables.")
    .addError(9, 23232323, "'a' has already been declared.")
    .addError(13, 23232323, "'b' has already been declared.")
    .test(src, {
      esnext: true
    });
...
exports["test typeof in TDZ"] = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "'b' was used before it was declared, which is illegal for 'let' variables.")
    .test(src, {
      esnext: true
    });
...
exports.testConstModification = function (test) {
  ...
  TestRun(test)
      .addError(3, 23232323, "Attempting to override 'a' which is a constant.")
      .addError(4, 23232323, "Attempting to override 'b' which is a constant.")
      .addError(5, 23232323, "Attempting to override 'a' which is a constant.")
      .addError(6, 23232323, "Attempting to override 'a' which is a constant.")
      .addError(7, 23232323, "Attempting to override 'a' which is a constant.")
      .addError(8, 23232323, "Attempting to override 'a' which is a constant.")
      .addError(8, 23232323, "You might be leaking a variable (a) here.")
      .addError(53, 23232323, "Missing '()' invoking a constructor.")
      .addError(55, 23232323, "Attempting to override 'f' which is a constant.")
      .test(src, {
        esnext: true
      });
...
exports.classIsBlockScoped = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "'A' was used before it was declared, which is illegal for 'class' variables.")
    .addError(4, 23232323, "'C' was used before it was declared, which is illegal for 'class' variables.")
    .addError(5, 23232323, "'D' is not defined.")
    .addError(9, 23232323, "'D' is not defined.")
    .addError(13, 23232323, "'F' is not defined.")
...
exports.testES6ModulesNamedExportsAffectUndef = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "'foo' is not defined.")
    .test(src1, {
      esnext: true,
      undef: true
    });
...
exports.testES6ModulesThroughExportDoNotAffectUnused = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "'foo' is defined but never used.")
    .test(src1, {
      esnext: true,
      unused: true
    });
...
exports.testES6ModulesThroughExportDoNotAffectUndef = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "'foo' is not defined.")
    .test(src1, {
      esnext: true,
      undef: true
    });
...
exports.testES6ModulesNameSpaceImportsAffectUnused = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "'angular' is defined but never used.")
    .test(src, {
      esnext: true,
      unused: true
    });
...
exports.testES6TemplateLiterals = function (test) {
  ...
  var run = TestRun(test)
    .addError(14, 23232323, "Octal literals are not allowed in strict mode.")
    .addError(21, 23232323, "Unclosed template literal.");
...
exports.testES6TaggedTemplateLiterals = function (test) {
  ...
  TestRun(test)
    .addError(16, 23232323, "Octal literals are not allowed in strict mode.")
    .addError(23, 23232323, "Unclosed template literal.")
    .test(src, { esnext: true });
  test.done();
};
...
exports.testES6TemplateLiteralsUndef = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "'a' is not defined.")
...
exports.testES6TaggedTemplateLiteralsUndef = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "'tag' is not defined.")
    .addError(2, 23232323, "'a' is not defined.")
    .test(src, { esnext: true, undef: true });
...
exports.testES6ExportStarFrom = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "Expected 'from' and instead saw 'foo'.")
    .addError(2, 23232323, "Expected '(string)' and instead saw ';'.")
    .addError(2, 23232323, "Missing semicolon.")
    .addError(3, 23232323, "Expected '(string)' and instead saw '78'.")
    .test(src, { esnext: true });
  test.done();
};
...
exports.testPotentialVariableLeak = function (test) {
  ...
  // Real Error
  TestRun(test)
    .addError(2, 23232323, "You might be leaking a variable (b) here.")
    .addError(3, 23232323, "You might be leaking a variable (d) here.")
    .addError(4, 23232323, "You might be leaking a variable (f) here.")
    .test(a, { esnext: true });
...
exports.testDefaultArguments = function (test) {
  ...
  TestRun(test)
    .addError(14, 23232323, "'bar' is not defined.")
    .addError(14, 23232323, "'num3' was used before it was declared, which is illegal for 'param' variables.")
    .addError(15, 23232323, "'num4' was used before it was declared, which is illegal for 'param' variables.")
    .addError(18, 23232323, "Regular parameters should not come after default parameters.")
    .addError(27, 23232323, "'c' is not defined.")
    .addError(33, 23232323, "'d' was used before it was defined.")
    .addError(36, 23232323, "'e' was used before it was declared, which is illegal for 'param' variables.")
  ...
  TestRun(test)
    .addError(7, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(11, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(12, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(13, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(14, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(14, 23232323, "'num3' was used before it was declared, which is illegal for 'param' variables.")
    .addError(15, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(15, 23232323, "'num4' was used before it was declared, which is illegal for 'param' variables.")
    .addError(18, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(18, 23232323, "Regular parameters should not come after default parameters.")
    .addError(26, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(31, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(33, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(35, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(36, 23232323, "'default parameters' is only available in ES6 (use 'esversion: 6').")
    .addError(36, 23232323, "'e' was used before it was declared, which is illegal for 'param' variables.")
    .test(src, {  });
...
exports.testDuplicateParamNames = function (test) {
  ...
  TestRun(test)
    .addError(7, 23232323, "'a' has already been declared.")
    .addError(11, 23232323, "'a' has already been declared.")
    .addError(17, 23232323, "'a' has already been declared.")
    .addError(18, 23232323, "Unnecessary directive \"use strict\".")
    .test(src, { shadow: true });

  TestRun(test)
    .addError(2, 23232323, "'a' is already defined.")
    .addError(7, 23232323, "'a' has already been declared.")
    .addError(11, 23232323, "'a' has already been declared.")
    .addError(17, 23232323, "'a' has already been declared.")
    .addError(18, 23232323, "Unnecessary directive \"use strict\".")
...
exports.testColumnNumAfterNonStrictComparison = function (test) {
  var src =  "if (1 == 1) {\n" +
        ...
        "}";
  TestRun(test)
    .addError(1, 23232323, "Expected '===' and instead saw '=='.", {character: 9})
    .addError(3, 23232323, "Expected '!==' and instead saw '!='.", {character: 11})
...
exports.testEscapedReservedWords = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "Expected an identifier and instead saw 'var' (a reserved word).")
    .addError(2, 23232323, "Expected an identifier and instead saw 'var'.")
    .test(code);
...
exports.testPermitEvalAsKey = function (test) {
  ...
  // browser globals
  TestRun(test)
  .addError(17, 23232323, "eval can be harmful.")
  .addError(19, 23232323, "eval can be harmful.")
  .addError(20, 23232323, "eval can be harmful.")
  .addError(22, 23232323, "eval can be harmful.")
  .addError(23, 23232323, "eval can be harmful.")
  .addError(25, 23232323, "eval can be harmful.")
  .test(srcBrowser, { browser: true });

  // node globals
  TestRun(test)
  .addError(18, 23232323, "eval can be harmful.")
  .addError(19, 23232323, "eval can be harmful.")
  .addError(20, 23232323, "eval can be harmful.")
  .addError(22, 23232323, "eval can be harmful.")
...
exports.labelsOutOfScope = function (test) {
  ...
  TestRun(test)
    .addError(10, 23232323, "'foo' is not a statement label.")
    .addError(12, 23232323, "'bar' is not a statement label.")
    .addError(14, 23232323, "'doesnotexist' is not a statement label.")
    .addError(22, 23232323, "'bar' is not a statement label.")
    .addError(24, 23232323, "'baz' is not a statement label.")
    .test(src);

  // See gh-3055 "Labels Break JSHint"
  TestRun(test, "following labeled block")
    .addError(2, 23232323, "'x' is not a statement label.")
    .test([
      "x: {}",
      "break x;"
    ]);
...
exports.labelDoesNotExistInGlobalScope = function (test) {
  ...
  TestRun(test)
    .addError(3, 23232323, "'nonExistent' is not a statement label.")
    .test(src);
...
exports.labeledContinueWithoutLoop = function (test) {
  ...
  TestRun(test)
    .addError(3, 23232323, "Unexpected 'continue'.")
    .test(src);
...
exports.unlabeledBreakWithoutLoop = function(test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "Unexpected 'break'.")
    .test(src);
...
exports.unlabeledContinueWithoutLoop = function(test) {
  ...
  TestRun(test)
    .addError(3, 23232323, "Unexpected 'continue'.")
    .addError(5, 23232323, "Unexpected 'continue'.")
    .test(src);
...
exports.labelsContinue = function (test) {
  ...
  TestRun(test)
    .addError(5, 23232323, "'nonExistent' is not a statement label.")
    .test(src);
...
exports.tryWithoutCatch = function (test) {
  ...
  TestRun(test)
    .addError(2, 23232323, "Expected 'catch' and instead saw 'if'.")
    .test(src);
  ...
  TestRun(test)
    .addError(1, 23232323, "Expected 'catch' and instead saw ''.")
    .test(src);
...
exports["gh-1920"] = function (test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "The body of a for in should be wrapped in an if statement to filter unwanted properties from the prototype.")
    .test(src, { forin: true });
...
exports.duplicateProto = function (test) {
  ...
  TestRun(test, "Duplicate `let`s")
    .addError(3, 23232323, "'__proto__' has already been declared.")
  ...
  TestRun(test, "Duplicate labels")
    .addError(2, 23232323, "'__proto__' has already been declared.")
    .test(src, { proto: true });
...
exports["gh-2761"] = function (test) {
  ...
  TestRun(test, "W021")
    .addError(2, 23232323, "Reassignment of 'a', which is is a function. " +
              "Use 'var' or 'let' to declare bindings that may change.")
    .addError(6, 23232323, "Reassignment of 'a', which is is a function. " +
              "Use 'var' or 'let' to declare bindings that may change.")
    .test(code);
...
exports["gh-2838"] = function (test) {
  ...
  TestRun(test, "Same-scope reference following sub-scope reference")
    .addError(5, 23232323, "'c' was used before it was declared, which is illegal for 'let' variables.")
  ...
  TestRun(test, "Same-scope assignment following sub-scope reference")
    .addError(5, 23232323, "'d' was used before it was declared, which is illegal for 'let' variables.")
    .test(code, { esversion: 6 });
...
exports["TDZ within initializer of lexical declarations"] = function(test) {
  ...
  TestRun(test)
    ...
    .addError(6, 23232323, "'e' was used before it was declared, which is illegal for 'let' variables.")
    .addError(10, 23232323, "'f' was used before it was declared, which is illegal for 'const' variables.")
    .addError(15, 23232323, "'l' was used before it was declared, which is illegal for 'let' variables.")
    .addError(16, 23232323, "'n' was used before it was declared, which is illegal for 'const' variables.")
    .addError(17, 23232323, "'o' was used before it was declared, which is illegal for 'let' variables.")
    .addError(18, 23232323, "'p' was used before it was declared, which is illegal for 'const' variables.")
    .test(code, { esversion: 6 });
...
exports["TDZ within class heritage definition"] = function(test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "'A' was used before it was declared, which is illegal for 'let' variables.")
    .addError(2, 23232323, "'B' was used before it was declared, which is illegal for 'let' variables.")
    .addError(4, 23232323, "'D' was used before it was declared, which is illegal for 'const' variables.")
    .addError(5, 23232323, "'E' was used before it was declared, which is illegal for 'const' variables.")
    .addError(7, 23232323, "'G' was used before it was declared, which is illegal for 'class' variables.")
    .addError(8, 23232323, "'H' was used before it was declared, which is illegal for 'class' variables.")
    .test(code, { esversion: 6 });
...
exports["TDZ within for in/of head"] = function(test) {
  ...
  TestRun(test)
    .addError(1, 23232323, "'a' was used before it was declared, which is illegal for 'let' variables.")
    .addError(2, 23232323, "'b' was used before it was declared, which is illegal for 'const' variables.")
    .addError(3, 23232323, "'c' was used before it was declared, which is illegal for 'let' variables.")
    .addError(4, 23232323, "'d' was used before it was declared, which is illegal for 'const' variables.")
    .addError(5, 23232323, "'e' was used before it was declared, which is illegal for 'let' variables.")
    .addError(6, 23232323, "'f' was used before it was declared, which is illegal for 'const' variables.")
    .addError(7, 23232323, "'g' was used before it was declared, which is illegal for 'let' variables.")
    .addError(8, 23232323, "'h' was used before it was declared, which is illegal for 'const' variables.")
    .test(code, { esversion: 6 });
