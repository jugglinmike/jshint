...
exports.jQuery_1_7 = function (test) {
  ...
  TestRun(test)
    .addError(551, 13, "'name' is defined but never used.")
    .addError(1044, 5, "'actual' is defined but never used.")
    .addError(1312, 4, "'pCount' is defined but never used.")
    .addError(1369, 3, "'events' is defined but never used.")
    .addError(1607, 32, "'table' is defined but never used.")
    .addError(1710, 4, "'internalKey' is defined but never used.")
    .addError(1813, 4, "'internalKey' is defined but never used.")
    .addError(2818, 12, "Expected an assignment or function call and instead saw an expression.")
    .addError(2822, 24, "Expected an assignment or function call and instead saw an expression.")
    .addError(2859, 5, "'rnamespaces' is defined but never used.")
    .addError(2861, 2, "'rperiod' is defined but never used.")
    .addError(2862, 2, "'rspaces' is defined but never used.")
    .addError(2863, 2, "'rescape' is defined but never used.")
    .addError(2900, 17, "'quick' is defined but never used.")
    .addError(3269, 69, "'related' is defined but never used.")
    .addError(3592, 5, "'selector' is defined but never used.")
    .addError(4465, 25, "'curLoop' is defined but never used.")
    .addError(4560, 21, "Expected an assignment or function call and instead saw an expression.")
    .addError(4694, 23, "'cache' is defined but never used.")
    .addError(4712, 17, "Expected a 'break' statement before 'case'.")
    .addError(4843, 74, "Expected an assignment or function call and instead saw an expression.")
    .addError(5635, 35, "'elem' is defined but never used.")
    .addError(5675, 48, "'i' is defined but never used.")
    .addError(5691, 47, "'i' is defined but never used.")
    .addError(7141, 38, "'i' is defined but never used.")
...
exports.prototype_1_7 = function (test) {
  ...
  TestRun(test)
    ...
    .addError(4036, 8, "'ret' is already defined.")
    .addError(4072, 54, "'cur' used out of scope.")
    .addError(4085, 14, "'i' is already defined.")
    .addError(4132, 29, "'match' is already defined.")
    .addError(4290, 15, "'i' is already defined.")
    .addError(4290, 22, "'l' is already defined.")
    .addError(4291, 10, "'elem' is already defined.")
    .addError(4312, 52, "'nodeCheck' used out of scope.")
    .addError(4322, 57, "'nodeCheck' used out of scope.")
    .addError(4520, 15, "'i' is already defined.")
    .addError(4538, 17, "Expected a 'break' statement before 'case'.")
    .addError(4656, 15, "'i' is already defined.")
    .addError(4722, 24, "Missing '()' invoking a constructor.")
